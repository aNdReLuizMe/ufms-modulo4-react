        ...
        <body className={inter.className}>
          <div>
            <div className="navbar items-center p-5 bg-blue-500  text-white fixed top-0 w-full justify-between">
              <a className="btn btn-ghost normal-case text-xl">Img UFMS</a>
          ...
          <footer className="footer items-center p-4 bg-blue-500 text-white fixed bottom-0 w-full">
            <aside className="items-center grid-flow-col">
              ...
              <p>Checkout Módulo 04 - André Luiz Rodrigues Pereira</p>
            </aside>
          </footer>
        </body>
      </html >

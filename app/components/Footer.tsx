...
const Footer = () => {
   return (
      <footer className="footer flex items-center p-4 bg-blue-500 text-white fixed bottom-0 w-full justify-between">
         <aside className="items-center grid-flow-col">
            ...
            <p>Checkout Módulo 04</p>
         </aside>
               <a href='https://www.linkedin.com/in/andreluizme/' target='blank'><strong className='text-white hover:text-black'>André Luiz R. Pereira</strong></a>
      </footer>
   )
}
